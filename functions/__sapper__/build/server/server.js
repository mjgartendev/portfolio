...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<ul class="svelte-1j35tjc">
		<li class="svelte-1j35tjc">
			<h3 class="svelte-1j35tjc">🌥️ Cloud Lover 🌩️</h3>
			<p class="svelte-1j35tjc">Local CLI's &amp; IDE's are super cool, but cloud tools are the cat's meow. And cloud IDE's with container-backed CLI's are probably the bee's knees.</p>
			<p class="svelte-1j35tjc">I've done everything from .NET Core API deployments with custom logging and performance monitoring on Azure, AWS &amp; Google Cloud, to headless CMS powered PWA's deployed all static and free basically anywhere.</p>
		</li>
		<li class="svelte-1j35tjc">
			<h3 class="svelte-1j35tjc">💻 Web Developer 🌎</h3>
			<p class="svelte-1j35tjc">I've spent a lot of time debugging unpleasant applications in legacy environments. That's a lot of time nobody is getting back, and for that reason I'm obssessed with writing minimal-dependency, lightning-fast code.</p>
			<p class="svelte-1j35tjc">I'm an explorer of the native web platform and comfortable with any component based framework. Typescript, async/await, flat-maps, shadow dom, named slots, custom props, and css grid are all cool too.</p>
		</li>
		<li class="svelte-1j35tjc">
			<h3 class="svelte-1j35tjc">👔 Corporate Survivor 💼</h3>
			<p class="svelte-1j35tjc">I have a Marketing Management degree and tons of years in personal sales, project management, and client-facing roles. I have a pretty good idea what gets the stakeholders out of bed in the morning.</p>
			<p class="svelte-1j35tjc">But please don't make me sell things. I'd rather spend time building something that sells itself.</p>
		</li>
	</ul>
	</section>`;
});
...
const Index$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div id="md-input" class="svelte-184x1k1"></div>
	<div id="md-output" class="svelte-184x1k1"></div>
	</section>`;
});
...
const Links = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<h1>Links</h1>
	<ul>
	  ${each(links, (link) => `<a${(v => v == null ? "" : ` href="${escape(link.href)}"`)(link.href)}${(v => v == null ? "" : ` alt="${escape(link.description)}"`)(link.description)} target="_blank" class="svelte-1uo0upg">
	    <span${(v => v == null ? "" : ` class="${escape(link.icon)}"`)(link.icon)}></span> ${escape(link.name)}
	  </a>
	  <p class="svelte-1uo0upg">${escape(link.description)}</p>
	  <hr>`)}
	</ul>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="svelte-190tddn">
		...
		<a rel="prefetch" class="${escape(segment === "resume" ? "selected" : "")} svelte-190tddn" href="resume">resume</a>
		<a class="${escape(segment === undefined ? "selected" : "")} title svelte-190tddn" href=".">mjgartendev</a>
		<a rel="prefetch" class="${escape(segment === "portfolio" ? "selected" : "")} svelte-190tddn" href="portfolio">portfolio</a>
		<a rel="prefetch" class="${escape(segment === "blog" ? "selected" : "")} svelte-190tddn" href="blog">blog</a>
	</nav>`;
});
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/admin\/?$/,
			parts: [
				{ name: "admin", file: "admin/index.svelte", component: Index$1 }
			]
		},

		{
			...
			pattern: /^\/links\/?$/,
			parts: [
				{ name: "links", file: "links.svelte", component: Links }
			]
		},
...
/* src\node_modules\@sapper\internal\App.svelte generated by Svelte v3.4.4 */
