...
<script>
	let projects = [
		{name: "Monaco Editor Playground", description: "Component IDE using Monaco Editor wrapped with Svelte 3, backed by Firestore realtime data", href:"https://svelte-playground.web.app"},
